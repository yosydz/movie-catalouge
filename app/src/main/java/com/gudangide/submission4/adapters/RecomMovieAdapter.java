...
public class RecomMovieAdapter extends RecyclerView.Adapter<RecomMovieAdapter.ViewHolder> {

    private List<Recomendation> movieArrayList;
    private Context context;
    private static ClickListener clickListener;

    public RecomMovieAdapter(List<Recomendation> arrayList, Context context) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecomMovieAdapter.ViewHolder holder, int position) {
        Recomendation movie = movieArrayList.get(position);
    ...
    public void setOnItemClickListener(ClickListener clickListener) {
        RecomMovieAdapter.clickListener = clickListener;
    }
